...
class SupsysticGallery
{
    ...
    public function __construct()
    {
        ...
        $environment = new Rsc_Environment('sgg', '1.8.2', $pluginPath);
    ...
    public function addShortcodeButton() {
        ...
        if(is_admin()) {
            wp_enqueue_script('sgg-bpopup-js', $this->environment->getConfig()->get('plugin_url') . '/app/assets/js/jquery.bpopup.min.js',array(),false,true);
