      ...
      var isOverPanel, isOverBarX, isOverBarY, isDragg, queueHideX, queueHideY, touchDifX, touchDifY,
        ...
        var _triggerInit = function() {
          ...
          var hammer = new Hammer_gg(me.context),
              scroll_width = $(window).width() * 0.01;
          hammer.get('pan').set({ threshold : scroll_width});
          hammer.on('panleft',function(e){scrollContent(0,scroll_width,true,false)});
          hammer.on('panright',function(e){scrollContent(0,-scroll_width,true,false)});
        };
        _triggerInit();
