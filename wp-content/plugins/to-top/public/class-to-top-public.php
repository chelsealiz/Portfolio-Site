...
class To_Top_Public {
	...
	public function public_display() {
		...
		if ( 'icon' == $option['style'] ) {
			echo '<div id="to_top_scrollup" class="dashicons ' . esc_attr( $option['icon_type'] ) .'"><span class="screen-reader-text">' . __( 'Scroll Up', 'to-top' ) . '</span></div>' ;
		}
		else if ( 'genericon-icon' == $option['style'] ) {
			...
			echo '<div id="to_top_scrollup" class="' . esc_attr( $class ) .'"><span class="screen-reader-text">' . __( 'Scroll Up', 'to-top' ) . '</span></div>' ;
		}
		else if ( 'font-awesome-icon' == $option['style'] ) {
			if (  'dashicons-arrow-up' == $option['icon_type'] ) {
			...
			echo '<div id="to_top_scrollup"><img alt="' . esc_attr( $option['image_alt'] ) . '" src="' . esc_url( $option['image'] ) . '"/></div>' ;
		}
	}
